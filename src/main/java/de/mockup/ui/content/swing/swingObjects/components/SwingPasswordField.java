...
public class SwingPasswordField extends SwingComponent<JPasswordField> {

	public SwingPasswordField(BaseComponentModel model) {
		super(new JPasswordField(), model);
	}

	@Override
	public String getType() {
		return ModelTypes.Fields.PASSWORDFIELD;
	}
