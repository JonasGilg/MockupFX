...
public class SwingToolTip extends SwingComponent<JToolTip> {

	public SwingToolTip(BaseComponentModel model) {
		super(new JToolTip(), model);
	}

	@Override
	public String getType() {
		return ModelTypes.TOOLTIP;
	}
	...
	@Override public List<String> getStringKeys(){
		...
		result.add(getIdentifier() + "_" + "tooltiptext");
		return result;
	}
}