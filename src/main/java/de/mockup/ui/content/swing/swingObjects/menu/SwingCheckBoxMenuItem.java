...
public class SwingCheckBoxMenuItem extends SwingComponent<JCheckBoxMenuItem> {

	public SwingCheckBoxMenuItem(BaseComponentModel model) {
		super(new JCheckBoxMenuItem(), model);
	}
