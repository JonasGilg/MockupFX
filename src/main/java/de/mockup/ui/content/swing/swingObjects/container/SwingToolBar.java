...
public class SwingToolBar extends SwingComponent<JToolBar> {


	public SwingToolBar(BaseComponentModel model) {
		super(new JToolBar(), model);
	}

	@Override
	public String getType() {
		return ModelTypes.TOOL_BAR;
	}
