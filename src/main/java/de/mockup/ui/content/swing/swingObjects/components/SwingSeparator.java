...
public class SwingSeparator extends SwingComponent<JSeparator> {

	public SwingSeparator(BaseComponentModel model) {
		super(new JSeparator(), model);
	}

	@Override
	public String getType() {
		return ModelTypes.SEPERATOR;
	}
