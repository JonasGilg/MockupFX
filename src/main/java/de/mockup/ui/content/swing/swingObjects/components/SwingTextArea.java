...
public class SwingTextArea extends SwingComponent<JTextArea> {

	public SwingTextArea(BaseComponentModel model) {
		super(new JTextArea(), model);
	}

	@Override
	public String getType() {
		return ModelTypes.Fields.TEXT_AREA;
	}
